            ...
            <div className="lg:col-span-3">
              ...
              {activeTab === "help" && (
                <div className="bg-white rounded-3xl border border-brand-border/70 p-6 sm:p-8 shadow-2xs space-y-6">
                  ...
                  {/* 3 Real & Verified Support Options */}
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {/* 1. Email Support (Real configured support email) */}
                    <a
                    ...
                    {/* 2. Student Helpline (Neutral state: No fake telephone link or hours) */}
                    <div className="p-5 rounded-2xl bg-brand-bg-warm/60 border border-brand-border/80 flex flex-col justify-between">
                      <div className="flex items-start gap-3.5 mb-3">
                        <div className="p-2.5 rounded-xl bg-brand-bg-warm text-brand-text-muted border border-brand-border shrink-0">
                      ...
                      <div className="text-[11px] text-brand-text-subtle font-medium pt-2 border-t border-brand-border/60">
                        <span>Telephone support in setup</span>
                      </div>
                    </div>

                    {/* 3. Talk to an Agent (Neutral state: No fake agent claims) */}
                    <div className="p-5 rounded-2xl bg-brand-bg-warm/60 border border-brand-border/80 flex flex-col justify-between">
                      <div className="flex items-start gap-3.5 mb-3">
                        <div className="p-2.5 rounded-xl bg-brand-bg-warm text-brand-text-muted border border-brand-border shrink-0">
                      ...
                      <div className="text-[11px] text-brand-text-subtle font-medium pt-2 border-t border-brand-border/60">
                        <span>Direct assistance in development</span>
                      </div>
                    </div>
                  </div>
